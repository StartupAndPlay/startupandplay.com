                ...
                switch ($field->type) {
                    case 'text':
                        ...
                        <li>
                            ...
                            <p contenteditable="true" class="requiredField <?php echo $field->field; ?>" id="new-post-<?php echo $field->field; ?>-p" data-max-length="140" data-placeholder="<?php echo stripslashes( $field->label ); ?>"></p>
                            <input type="hidden" class="<?php echo $class; ?>" type="text" name="<?php echo $field->field; ?>" id="<?php echo $field->field; ?>" minlength="2" placeholder="<?php echo stripslashes( $field->label ); ?>" value="<?php echo stripslashes( $value ); ?>">
                            <div class="clear"></div>
